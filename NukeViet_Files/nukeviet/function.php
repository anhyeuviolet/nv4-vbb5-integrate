...
function build_query_array ( $userid, $permanent )
{
    ...
    $thisvars = array( 
        'sessionhash' => $sessionhash, 'dbsessionhash' => $sessionhash, 'userid' => intval( $userid ), 'host' => $client_info['ip'], 'idhash' => md5( NV_USER_AGENT . fetch_substr_ip( $client_info['ip'] ) ), 'lastactivity' => NV_CURRENTTIME, 'location' => '', 'styleid' => 0, 'languageid' => 0, 'loggedin' => intval( $userid ) ? 1 : 0, 'inforum' => 0, 'inthread' => 0, 'incalendar' => 0, 'badlocation' => 0, 'profileupdate' => 0, 'useragent' => NV_USER_AGENT, 'bypass' => 0 
    );
